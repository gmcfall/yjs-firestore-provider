import { getFirestore, doc, setDoc, serverTimestamp, getDoc, deleteDoc, query, collection, onSnapshot, writeBatch, runTransaction, Bytes, getDocs } from '@firebase/firestore';
...
function currentTime(firebaseApp, path) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield setDoc(ref, { now: serverTimestamp() });
            const after = Date.now();
            const avg = Math.floor((before + after) / 2);
            const nowDoc = yield getDoc(ref);
            if (nowDoc.exists()) {
    ...
    compress() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield runTransaction(db, (txn) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (baselineDoc.exists()) {
                        ...
                        update = Y.mergeUpdates([baselineData.update.toUint8Array(), newUpdates]);
                    }
                    else {
                        update = newUpdates;
                    }
...
export { FirestoreProvider, deleteYjsData };
